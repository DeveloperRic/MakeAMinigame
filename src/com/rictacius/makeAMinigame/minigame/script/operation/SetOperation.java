...
import com.rictacius.makeAMinigame.minigame.script.ScriptLine;
...
import com.rictacius.makeAMinigame.minigame.script.Script.Section;
...
public class SetOperation extends Operation {
	...
	public SetOperation(String raw, String left, String right, Script script, ScriptLine source) {
		super(raw);
		this.left = left;
		this.right = right;
		this.source = source;
